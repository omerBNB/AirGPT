<template>
  <section class="app-footer-mobile">
    <section class="footer-mobile">
      <div class="coffeerights-mobile">
        <RouterLink class="search-footer-btn-mobile" to="/">
            <svg
              viewBox="0 0 32 32"
        ...
        <RouterLink class="search-footer-btn-mobile" to="/wishlist">
          <div>
            <svg
              viewBox="0 0 32 32"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <button class="search-footer-btn-mobile" @click="goTo('trips')">
          <img class="logo-moble" src="../../src/imgs/Airbnb_logo/airbnblogo.svg" alt="logo" />
          <span>Trips</span>
        </button>
        <button class="search-footer-btn-mobile" @click="goTo('dashboard')">
          <svg
            viewBox="0 0 32 32"
            xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true"
