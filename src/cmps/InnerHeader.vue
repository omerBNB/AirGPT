<template>
  <section class="inner-header-container">
    <button class="where-to-btn">
      <form action="">
        <div>Where</div>
        <input class="where-to-input" type="search" placeholder="Search destinations" />
      </form>
    </button>
    <div class="border-inner-header"></div>
    <button class="inner-header-dates-btn">
      <div>Check in</div>
      <div>Add dates</div>
    </button>
    <div class="where-to-input"></div>
    <button class="inner-header-dates-btn">
      <div>Check out</div>
      <div>Add dates</div>
    </button>
    ...
    <button class="inner-header-search-btn big">
      <div class="s1qcpybl dir dir-ltr" data-icon="true" data-testid="little-search-icon">
        <svg
          viewBox="0 0 32 32"
